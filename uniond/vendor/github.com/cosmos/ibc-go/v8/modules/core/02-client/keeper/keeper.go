...
func NewKeeper(cdc codec.BinaryCodec, storeService corestore.KVStoreService, legacySubspace types.ParamSubspace, sk types.StakingKeeper, uk types.UpgradeKeeper) Keeper {
	return Keeper{
...
func (k Keeper) CreateLocalhostClient(ctx context.Context) error {
...
func (k Keeper) UpdateLocalhostClient(ctx context.Context, clientState exported.ClientState) []exported.Height {
...
func (k Keeper) GetSelfConsensusState(ctx context.Context, height exported.Height) (exported.ConsensusState, error) {
...
func (k Keeper) GetClientStatus(ctx context.Context, clientState exported.ClientState, clientID string) exported.Status {
