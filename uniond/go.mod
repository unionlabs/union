...
replace (
	github.com/cometbft/cometbft => github.com/unionlabs/cometbls v0.0.0-20230829063146-368fe576a2bd
	...
	github.com/cosmos/ibc-go/v7 => github.com/unionlabs/ibc-go/v7 v7.0.0-20230829071836-44baa00ab151
