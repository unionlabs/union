...
replace (
	github.com/cometbft/cometbft => github.com/unionlabs/cometbls v0.0.0-20231106175114-e2f7fc6533da
	...
	github.com/cosmos/ibc-go/v7 => github.com/unionlabs/ibc-go/v7 v7.0.0-20231106181551-77b436d597be
