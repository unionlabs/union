...
// // Nb of tokens for each val in devnet
// func toValidator(pubKey []byte, power int64) (*types.SimpleValidator, error) {
// 	protoPK, err := ce.PubKeyToProto(cometbn254.PubKey(pubKey))
// 	if err != nil {
...
// func attack1(t *testing.T, privIn privateInputs, totalPower int64, signedBytes []byte) {
...
// 	fakeValidatorsInput, _, err := marshalValidators([]*types.SimpleValidator{fakeVal})
// 	if err != nil {
// 		t.Fatal(err)
// 	}
...
// // consensus.
// func attack2(t *testing.T, privIn privateInputs, totalPower int64, signedBytes []byte) {
