...
pub struct ChannelOpenTryEvent {
    ...
    pub counterparty_version: ChannelVersion,
}
...
mod tests {
    ...
    /// Creates a test ChannelOpenTryEvent with unique deterministic values
    fn create_test_event(suffix: u32) -> ChannelOpenTryEvent {
        ...
        ChannelOpenTryEvent {
            ...
            counterparty_version: ChannelVersion(format!("counterparty-version-{}", suffix)),
        }
    }
  ...
  "counterparty_version": "counterparty-version-42",
  "event_index": "42",
  "height": "10042",
