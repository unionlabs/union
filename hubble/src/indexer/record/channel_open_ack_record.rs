...
impl HasKind for ChannelOpenAckRecord {
    fn kind() -> RecordKind {
        RecordKind::ChannelOpenAck
    }
}
...
impl ChannelOpenAckRecord {
    pub async fn insert(
        ...
        sqlx::query!(
            r#"
            INSERT INTO v2_sync.channel_open_ack_sync (
                internal_chain_id,
                block_hash,
                height,
                event_index,
    ...
    pub async fn delete_by_chain_and_height(
        ...
        let result = sqlx::query!(
            r#"
            DELETE FROM v2_sync.channel_open_ack_sync
