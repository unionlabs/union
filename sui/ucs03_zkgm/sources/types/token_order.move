...
module zkgm::token_order {
    ...
    #[test]
    fun test_decode_me_hard() {
        let encoded = x"";

        let operand = *zkgm::zkgm_packet::decode(&encoded).instruction().operand();

        let token_order = decode(&operand);
        
        std::debug::print(&token_order);
    }
}
