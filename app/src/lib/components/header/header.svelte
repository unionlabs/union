...
import AutoExpandedInput from "$lib/components/auto-expanded-input.svelte"
</script>

<header
  class={cn(
    'p-3 min-w-full w-screen flex flex-row items-center',
    'bg-card flex justify-between gap-x-3 border-b-[1px] border-solid border-secondary/65',
  )}
>
  <Button
    href="/"
