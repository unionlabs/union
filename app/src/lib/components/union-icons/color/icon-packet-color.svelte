...
<svg class={className} viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
  <g clip-path="url(#clip0_154_198)">
    ...
    <path d="M3.10289 4.53868L6.5 2.57735L9.89711 4.53868V8.46133L6.5 10.4226L3.10289 8.46133V4.53868Z" stroke="black"/>
    <path d="M6.5 3L4 4.5L6.5 6L9 4.5L6.5 3Z" fill="#A0ECFD"/>
    <path d="M3 4.5L6.5 6.5L10 4.5" stroke="black"/>
  </g>
  <defs>
