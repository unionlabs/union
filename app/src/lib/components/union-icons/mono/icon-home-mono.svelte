...
<svg class={className} viewBox="0 0 65 65" fill="none" xmlns="http://www.w3.org/2000/svg">
  <g clip-path="url(#clip0_402_371)">
    ...
    <path d="M15 26.6667V50H50V26.6667L32.5 15L15 26.6667Z" stroke="currentColor" stroke-width="5"/>
    <rect x="30" y="35" width="5" height="15" fill="currentColor"/>
    <rect x="30" y="25" width="5" height="5" fill="currentColor"/>
  </g>
  <defs>
