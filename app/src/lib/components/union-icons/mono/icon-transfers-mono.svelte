...
<svg class={className} viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
  <g clip-path="url(#clip0_106_860)">
    <rect x="0.5" y="0.5" width="12" height="12" rx="0.5" fill="white" stroke="black"/>
    <rect x="1" y="3" width="8" height="2" fill="black"/>
    <rect x="4" y="8" width="8" height="2" fill="black"/>
    <path d="M1 9L4 6V12L1 9Z" fill="black"/>
    <path d="M12 4L9 7L9 1L12 4Z" fill="black"/>
  </g>
  <defs>
    <clipPath id="clip0_106_860">
