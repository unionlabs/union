...
<svg class={className} viewBox="0 0 65 65" fill="none" xmlns="http://www.w3.org/2000/svg">
  <g clip-path="url(#clip0_402_758)">
    <rect x="2.5" y="2.5" width="60" height="60" rx="2.5" stroke="black" stroke-width="5"/>
    ...
    <rect x="36.0352" y="39.5709" width="5" height="15" transform="rotate(-45 36.0352 39.5709)" fill="black"/>
    <rect x="14.8242" y="46.6422" width="15" height="5" transform="rotate(-45 14.8242 46.6422)" fill="black"/>
    <rect x="36.0352" y="25.4291" width="15" height="5" transform="rotate(-45 36.0352 25.4291)" fill="black"/>
