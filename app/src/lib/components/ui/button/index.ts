...
const buttonVariants = tv({
  ...
  variants: {
    variant: {
      ...
      link: "text-primary no-underline hover:no-underline font-supermolot font-bold text-md decoration-transparent uppercase rounded-none border-solid hover:bg-accent"
    },
    size: {
