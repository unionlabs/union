...
export const keplrChainInfo: KeplrChainInfo = {
    ...
    bech32Config: {
        ...
        bech32PrefixAccPub: "union" + "pub",
        bech32PrefixValAddr: "union" + "valoper",
        bech32PrefixValPub: "union" + "valoperpub",
        bech32PrefixConsAddr: "union" + "valcons",
        bech32PrefixConsPub: "union" + "valconspub",
    },
    currencies: [
        {
            coinDenom: "UNO",
