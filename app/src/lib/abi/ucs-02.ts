;[
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "nftClass", type: "address", indexed: true, internalType: "address" }
    ],
    anonymous: false
  },
  {
  ...
  { type: "error", name: "MustTransferAtLeastOneToken", inputs: [] },
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "nftClass", type: "address", internalType: "address" },
