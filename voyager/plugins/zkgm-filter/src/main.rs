...
use unionlabs::{
    ...
    never::Never,
    primitives::{Bech32, ByteArrayExt, Bytes, H32, H160},
};
...
mod tests {
    ...
    pub(crate) fn evm_checksum() {
        let tx_input = alloy::hex!(
            ""
        );
    ...
    fn successful_protocol_fill() {
        let ack = hex!(
            ""
        );

        assert!(is_successful_protocol_fill_ack(&ack));

        let ack = hex!(
            ""
        );
