    ...
    ModuleData: From<EventBatch<V>>,
{
    ...
    Ok((
        ...
        // TODO: This is somewhat inefficient currenntly, a top level seq is used to guarantee the tx ordering
        // NOTE: This might need to be a se depending on the impl of the client upadte plugin is.
        conc(exact_target_heights.into_iter().map(|height| {
            seq([
                call(WaitForHeight {
