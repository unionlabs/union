...
// impl<Hc: ChainExt, Tr: ChainExt, VARIANT, Any: AnyLightClient> From<Identified<Hc, Tr, VARIANT>>
//     for AnyLightClientIdentified<Any>
// where
//     VARIANT: Into<InnerOf<Any, Hc, Tr>>,
//     AnyLightClientIdentified<Any>: From<Identified<Hc, Tr, InnerOf<Any, Hc, Tr>>>,
// {
//     fn from(
//         crate::Identified {
//             chain_id,
//             t,
//             __marker: _,
//         }: Identified<Hc, Tr, VARIANT>,
//     ) -> Self {
//         Self::from(crate::Identified::new(
//             chain_id,
//             <InnerOf<Any, Hc, Tr>>::from(t),
//         ))
//     }
// }

// impl<Hc: ChainExt, Tr: ChainExt, VARIANT, Any: AnyLightClient>
//     TryFrom<AnyLightClientIdentified<Any>> for crate::Identified<Hc, Tr, VARIANT>
// where
//     Identified<Hc, Tr, InnerOf<Any, Hc, Tr>>: TryFrom<AnyLightClientIdentified<Any>, Error = AnyLightClientIdentified<Any>>
...
//             t,
//             __marker: _,
//         } = <crate::Identified<Hc, Tr, InnerOf<Any, Hc, Tr>>>::try_from(value)?;

//         Ok(crate::Identified::new(
//             chain_id.clone(),
//             VARIANT::try_from(t).map_err(|x: InnerOf<Any, Hc, Tr>| {
//                 Into::<AnyLightClientIdentified<_>>::into(crate::Identified::new(chain_id, x))
//             })?,
//         ))
//     }
