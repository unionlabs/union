...
use super::groth16_verifier_constants::{
    N_PUBLIC_INPUTS, commitment_precomputed_lines, ic, pedersen_g, pedersen_g_root_sigma_neg,
...
mod Groth16VerifierBN254 {
    ...
    use super::{
        FullProofWithHints, Groth16Proof, MPCheckHintBN254, N_PUBLIC_INPUTS,
        commitment_precomputed_lines, ic, pedersen_g, pedersen_g_root_sigma_neg, precomputed_lines,
        vk,
    };
