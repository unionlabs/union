...
let
  forge-deploy = pkgs.writeShellApplication {
    ...
    text = ''
      ...
      PRIVATE_KEY=0x${builtins.readFile ./../genesis/devnet-eth/dev-key0.prv} FOUNDRY_PROFILE="script" BYPASS_GITREV=1 forge script scripts/Deploy.s.sol:DeployDeployerAndIBC -vvv --rpc-url http://geth:8545 --broadcast ${
