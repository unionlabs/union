...
library UnionIbcLightclientsCometblsV1ClientState {
  ...
  struct Data {
    string chain_id;
    UnionIbcLightclientsCometblsV1Fraction.Data trust_level;
  ...
  function _read_trust_level(
    ...
    (UnionIbcLightclientsCometblsV1Fraction.Data memory x, uint256 sz) = _decode_UnionIbcLightclientsCometblsV1Fraction(p, bs);
    r.trust_level = x;
    return sz;
  }
   ...
   */
  function _decode_UnionIbcLightclientsCometblsV1Fraction(uint256 p, bytes memory bs)
    internal
    pure
    returns (UnionIbcLightclientsCometblsV1Fraction.Data memory, uint)
  {
    uint256 pointer = p;
    (uint256 sz, uint256 bytesRead) = ProtoBufRuntime._decode_varint(pointer, bs);
    pointer += bytesRead;
    (UnionIbcLightclientsCometblsV1Fraction.Data memory r, ) = UnionIbcLightclientsCometblsV1Fraction._decode(pointer, bs, sz);
    ...
    returns (uint)
  {
    ...
    pointer += UnionIbcLightclientsCometblsV1Fraction._encode_nested(r.trust_level, pointer, bs);
  ...
  function _estimate(
    ...
    e += 1 + ProtoBufRuntime._sz_lendelim(UnionIbcLightclientsCometblsV1Fraction._estimate(r.trust_level));
  ...
  function store(Data memory input, Data storage output) internal {
    ...
    UnionIbcLightclientsCometblsV1Fraction.store(input.trust_level, output.trust_level);
...
library UnionIbcLightclientsCometblsV1Misbehaviour {
  ...
  function _read_header_1(
    ...
    (UnionIbcLightclientsCometblsV1Header.Data memory x, uint256 sz) = _decode_UnionIbcLightclientsCometblsV1Header(p, bs);
    r.header_1 = x;
    return sz;
  }
   ...
   * @return The number of bytes used to decode
   */
  function _decode_UnionIbcLightclientsCometblsV1Header(uint256 p, bytes memory bs)
    internal
    pure
    returns (UnionIbcLightclientsCometblsV1Header.Data memory, uint)
  {
    uint256 pointer = p;
    (uint256 sz, uint256 bytesRead) = ProtoBufRuntime._decode_varint(pointer, bs);
    pointer += bytesRead;
    (UnionIbcLightclientsCometblsV1Header.Data memory r, ) = UnionIbcLightclientsCometblsV1Header._decode(pointer, bs, sz);
    return (r, sz + bytesRead);
  }
    ...
    returns (uint)
  {
    ...
    pointer += UnionIbcLightclientsCometblsV1Header._encode_nested(r.header_1, pointer, bs);
    ...
    pointer += UnionIbcLightclientsCometblsV1Header._encode_nested(r.header_2, pointer, bs);
  ...
  function _estimate(
    ...
    uint256 e;
    e += 1 + ProtoBufRuntime._sz_lendelim(UnionIbcLightclientsCometblsV1Header._estimate(r.header_1));
    e += 1 + ProtoBufRuntime._sz_lendelim(UnionIbcLightclientsCometblsV1Header._estimate(r.header_2));
    return e;
  }
  // empty checker
   ...
   */
  function store(Data memory input, Data storage output) internal {
    UnionIbcLightclientsCometblsV1Header.store(input.header_1, output.header_1);
    UnionIbcLightclientsCometblsV1Header.store(input.header_2, output.header_2);
...
library UnionIbcLightclientsCometblsV1Header {
    ...
    returns (uint)
  {
    ...
    pointer += ProtoBufRuntime._encode_bytes(r.untrusted_validator_set_root, pointer, bs);
    }
    ...
    pointer += ProtoBufRuntime._encode_bytes(r.zero_knowledge_proof, pointer, bs);
    }
    return pointer - offset;
  }
  // nested encoder
  ...
  function _estimate(
    ...
    e += 1 + ProtoBufRuntime._sz_lendelim(r.untrusted_validator_set_root.length);
  ...
  function store(Data memory input, Data storage output) internal {
    ...
    output.untrusted_validator_set_root = input.untrusted_validator_set_root;
...
library UnionIbcLightclientsCometblsV1Fraction {
