use unionlabs::ibc::lightclients::{cometbls, wasm};
...
pub fn apply_light_client_update(
    _client_state: &mut wasm::client_state::ClientState<cometbls::client_state::ClientState>,
    _consensus_state: &mut wasm::consensus_state::ConsensusState<
