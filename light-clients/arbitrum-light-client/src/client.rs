...
impl IbcClient for ArbitrumLightClient {
    ...
    fn update_state(
        ...
        if client_state.latest_height < header.l1_height {
            client_state.data.l1_latest_slot = updated_height.height();
...
mod test {
    ...
    const INITIAL_CONSENSUS_STATE_HEIGHT: Height = Height::new(950);

    const INITIAL_SUBSTITUTE_CONSENSUS_STATE_HEIGHT: Height = Height::new(970);
