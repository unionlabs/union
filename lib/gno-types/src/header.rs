...
use unionlabs::{
    ...
    primitives::{Bech32, H160, H256, encoding::Base64},
};
...
pub struct Header {
    ...
    pub time: Timestamp,
    #[serde(with = "::serde_utils::string")]
    pub num_txs: BoundedI64<0, { i64::MAX }>,
    #[serde(with = "::serde_utils::string")]
    pub total_txs: BoundedI64<0, { i64::MAX }>,
    ...
    pub last_commit_hash: Option<H256<Base64>>,
    /// transactions
    pub data_hash: Option<H256<Base64>>,
    /// hashes from the app output from the prev block
    ///
    /// validators for the current block
    pub validators_hash: H256<Base64>,
    /// validators for the next block
    pub next_validators_hash: H256<Base64>,
    /// consensus params for current block
    pub consensus_hash: H256<Base64>,
    /// state after txs from the previous block
    pub app_hash: Option<H256<Base64>>,
    /// root hash of all results from the txs from the previous block
    pub last_results_hash: Option<H256<Base64>>,
    /// original proposer of the block
    pub proposer_address: Bech32<H160>,
}
