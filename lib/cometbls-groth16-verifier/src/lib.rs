...
mod tests {
    ...
    fn test_ok() {
        assert!(matches!(
            verify_zkp(
                U256::from_big_endian_hex("0x17204f2b98c9e9a6c92c29ac7e19c1bf025530dee72793868ee9b040ca00417b").unwrap(),
                U256::from_big_endian_hex("0x17204f2b98c9e9a6c92c29ac7e19c1bf025530dee72793868ee9b040ca00417b").unwrap(),
    ...
    fn test_ko() {
        assert!(matches!(
            verify_zkp(
                U256::from_big_endian_hex("0x1bbacc23be35969ffcefc2892440045e83c3c78e81bf2d6473dd745a93835684").unwrap(),
                U256::from_big_endian_hex("0x1bbacc23be35969ffcefc2892440045e83c3c78e81bf2d6473dd745a93835684").unwrap(),
    ...
    fn test_ok_2() {
        assert_eq!(
            verify_zkp(
                U256::from_big_endian_hex("0x2f4975ab7e75a677f43efebf53e0ec05460d2cf55506ad08d6b05254f96a500d").unwrap(),
                U256::from_big_endian_hex("0x2f4975ab7e75a677f43efebf53e0ec05460d2cf55506ad08d6b05254f96a500d").unwrap(),
