...
mod tests {
    ...
    #[test]
    fn ethabi_encoding() {
        let bz = hex!("");
    ...
    fn bincode_encoding() {
        let bz =
            hex!("0800000000000000313131353531313101000000010000000c217d0000000000780020004000");
