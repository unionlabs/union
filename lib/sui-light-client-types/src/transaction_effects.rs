...
mod tests {
    ...
    fn effects_digest() {
        ...
        .unwrap();
        let effectv1 = TransactionEffectsV1 {
            status: super::ExecutionStatus::Success,
            executed_epoch: 732,
            gas_used: GasCostSummary {
                computation_cost: U64(1000000),
                storage_cost: U64(15139200),
                storage_rebate: U64(11000088),
                non_refundable_storage_fee: U64(111112),
            },
            modified_at_versions: vec![
                (
                    hex!("0ed5840c06ba5b53ed19307535a6d16ea7d8766532d3e1fc3f700aa50ffa1886").into(),
                    349179417,
                ),
                (
                    hex!("13665897ff02623508ba13414b1429bf3d367236b2d1db6ca17ad3dc93b8ac22").into(),
                    349179358,
                ),
                (
                    hex!("548762d87d8ccd4c0e3eda2065a2e2cb483a6a6e7c19d0823787571d4fcc3e5c").into(),
                    349179417,
                ),
                (
                    hex!("aa1ec2e2f63d5b910f87d5018af7aabcecb47365101e1d63fd67bcdc3a5ecad3").into(),
                    349179417,
                ),
                (
                    hex!("d594d3d7abbb958f48374fcd5d6233568c6e2b37fd21a7678323b8638b85a01d").into(),
                    349179417,
                ),
            ],
            shared_objects: vec![(
                ...
                349179417,
                Digest(
                    FixedBytes::from_str("4aDED9mjFhmE9KiM14EwfFULSNDeUyUC2wWhJQvHgorc").unwrap(),
                ),
            )],
            transaction_digest: Digest(
                FixedBytes::from_str("AkSTPmFuMe1ZwiZyLD1pZLS3jmZUA8NtYC8C9WR75q9e").unwrap(),
            ),
            created: vec![
                (
                    (
                        hex!("7118e4fff52d46e8d9998b92c2f9a2ba8df5e518507b92250f221af862837318")
                            .into(),
                        349179418,
                        Digest(
                            FixedBytes::from_str("51WyWhmyCDLCsX5tkm4rLqTa49QoRBthh4nGkFDvHYZy")
                                .unwrap(),
                        ),
                    ),
                    Owner::ObjectOwner(
                        hex!("ff1d72d8f107fd80bb4a1e925a886cb534e8a688883611d1fc8ed27a32cd2264")
                            .into(),
                    ),
                ),
                (
                    (
                        hex!("e809eb6e1c3b1077f08e3a1c8228a8e0d3c3480895a315e7911cc206886bdaed")
                            .into(),
                        349179418,
                        Digest(
                            FixedBytes::from_str("CkqPhGsV27HCaE28GcJnvwZXXspyFUfznCo5zN72bmfK")
                                .unwrap(),
                        ),
                    ),
                    Owner::ObjectOwner(
            ...
            mutated: vec![
                (
                    (
                        hex!("0ed5840c06ba5b53ed19307535a6d16ea7d8766532d3e1fc3f700aa50ffa1886")
                            .into(),
                        349179418,
                        Digest(
                            FixedBytes::from_str("61yatvBufX2raquzvUiRYysws4Lfuz5zbcp7ESLbmnWu")
                                .unwrap(),
                        ),
                    ),
                    Owner::ObjectOwner(
                ...
                (
                    (
                        hex!("13665897ff02623508ba13414b1429bf3d367236b2d1db6ca17ad3dc93b8ac22")
                            .into(),
                        349179418,
                        Digest(
                            FixedBytes::from_str("GJoYiQqdeEYBFcwUQNpebvqxB1dkvPRrReKgzzcqdhaR")
                                .unwrap(),
                        ),
                    ),
                    Owner::ObjectOwner(
                ...
                (
                    (
                        hex!("548762d87d8ccd4c0e3eda2065a2e2cb483a6a6e7c19d0823787571d4fcc3e5c")
                            .into(),
                        349179418,
                        Digest(
                            FixedBytes::from_str("GgENzEFKQmad5MKUkPUbqPfXLdYnqKJqZuYhkQSBvfL4")
                                .unwrap(),
                        ),
                    ),
                    Owner::AddressOwner(
                        hex!("232a4f7eb4c2abf5061316704373fd4bffbd297729406d9d04012931405f590b")
                            .into(),
                    ),
                ),
                (
                    (
                        hex!("aa1ec2e2f63d5b910f87d5018af7aabcecb47365101e1d63fd67bcdc3a5ecad3")
                            .into(),
                        349179418,
                        Digest(
                            FixedBytes::from_str("2CsBYiKN4PM5FzP2y2gxZPDPGi3nYsEd3AZWMWihDnsG")
                                .unwrap(),
                        ),
                    ),
                    Owner::Shared {
                        initial_shared_version: 349179355,
                    },
                ),
                (
                    (
                        hex!("d594d3d7abbb958f48374fcd5d6233568c6e2b37fd21a7678323b8638b85a01d")
                            .into(),
                        349179418,
                        Digest(
                            FixedBytes::from_str("HcBvaV8c9pWrWfCETtm7qb4dc2u1JTF1KDUqvuffPPk7")
                                .unwrap(),
                        ),
                    ),
                    Owner::ObjectOwner(
            ...
            gas_object: (
                ...
                Owner::AddressOwner(
                    hex!("232a4f7eb4c2abf5061316704373fd4bffbd297729406d9d04012931405f590b").into(),
                ),
            ),
            events_digest: Some(Digest(
                FixedBytes::from_str("A1LVLjTxxDz4GwQC89r9yWa9eeQb1QUxJe68nN59owmf").unwrap(),
            )),
            dependencies: vec![
                Digest(
                    FixedBytes::from_str("3r2UwwmR6sVBVxz7iM4dd3FiMzY7GFRbGLw9Cr5967LG").unwrap(),
                ),
                Digest(
                    FixedBytes::from_str("4UUGeshy4op8czzuT7MzcRZEZDSZvnf4feyvA3XpPXry").unwrap(),
                ),
            ],
        };

        let expected_digest =
            hex!("db4c1d5162e07b7ea450ad7bf606d0896d11a100a6d969373c91ab0976915208");

        panic!("{}", digest(&TransactionEffects::V2(effect)));
    }
}
