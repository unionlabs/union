...
pub mod proto {
    ...
    impl_proto_via_try_from_into!(ClientState => protos::ibc::lightclients::gno::v1::ClientState);

    use crate::{client_state::ClientState, fraction};

    impl From<ClientState> for protos::ibc::lightclients::gno::v1::ClientState {
    ...
    impl TryFrom<protos::ibc::lightclients::gno::v1::ClientState> for ClientState {
        type Error = Error;

        fn try_from(
            value: protos::ibc::lightclients::gno::v1::ClientState,
...
mod tests {
    ...
    #[test]
    fn proto_bytes_iso() {
        // voyager rpc client-state xion-testnet-2 "07-gno-1" --ibc-spec-id ibc-classic --height 4083948
