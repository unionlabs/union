...
pub mod proto {
    ...
    impl_proto_via_try_from_into!(Fraction => protos::ibc::lightclients::gno::v1::Fraction);

    impl From<Fraction> for protos::ibc::lightclients::gno::v1::Fraction {
    ...
    impl TryFrom<protos::ibc::lightclients::gno::v1::Fraction> for Fraction {
        type Error = Error;

        fn try_from(
            value: protos::ibc::lightclients::gno::v1::Fraction,
