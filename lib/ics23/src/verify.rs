...
mod tests {
    ...
    #[test]
    fn print_proof() {
        let proof = base64::decode("").unwrap();

        let commitment_proof = MerkleProof::decode(&proof).unwrap();

        println!(
            "Commitment:\n{}",
            serde_json::to_string_pretty(&commitment_proof).unwrap()
        );
    }
}
