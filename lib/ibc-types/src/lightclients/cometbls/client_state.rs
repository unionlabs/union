use contracts::glue::UnionIbcLightclientsCometblsV1ClientStateData;

use crate::{
    core::client::height::Height, errors::MissingField, google::protobuf::duration::Duration,
    lightclients::tendermint::fraction::Fraction, IntoProto, TryFromProto, TypeUrl,
};
...
impl From<ClientState> for UnionIbcLightclientsCometblsV1ClientStateData {
    fn from(value: ClientState) -> Self {
        Self {
            chain_id: value.chain_id,
...
impl From<UnionIbcLightclientsCometblsV1ClientStateData> for ClientState {
