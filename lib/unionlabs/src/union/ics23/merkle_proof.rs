...
pub mod proto {
    ...
    pub enum TryFromMerkleProofError {
        ...
        Existence(#[from] crate::union::ics23::existence_proof::proto::TryFromExistenceProofError),
        #[error("unable to decode non existence proof")]
        NonExistence(
            #[from] crate::union::ics23::non_existence_proof::proto::TryFromNonExistenceProofError,
        ),
    ...
    fn encode(self) -> Vec<u8> {
        ...
        match self {
            MerkleProof::Membership(a, b) => (
                ibc_solidity::ics23::ExistenceProof::from(a),
                ibc_solidity::ics23::ExistenceProof::from(b),
            )
                .abi_encode_packed(),
            MerkleProof::NonMembership(a, b) => (
                ibc_solidity::ics23::NonExistenceProof::from(a),
                ibc_solidity::ics23::ExistenceProof::from(b),
            )
                .abi_encode_packed(),
        }
