...
use crate::union::galois::prove_response::ProveResponse;
...
pub mod proto {
    use crate::{
        ...
        union::galois::{
            ...
            prove_response::proto::TryFromProveResponseError,
        },
    };
    ...
    impl TryFrom<protos::union::galois::api::v3::PollResponse> for PollResponse {
        ...
        fn try_from(
            value: protos::union::galois::api::v3::PollResponse,
        ) -> Result<Self, Self::Error> {
            match required!(value.result)? {
                protos::union::galois::api::v3::poll_response::Result::Pending(_) => {
                    Ok(Self::Pending)
                }
