...
use crate::{bounded::BoundedI64, hash::H256};

#[model(proto(raw(protos::tendermint::crypto::Proof), into, from))]
pub struct Proof {
...
pub mod proto {
    use crate::{
        bounded::BoundedIntError, errors::InvalidLength, tendermint::crypto::proof::Proof,
    };
