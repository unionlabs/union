...
use crate::ibc::core::channel::order::Order;
...
#[cfg(feature = "proto")]
pub mod proto {
    use crate::{errors::UnknownEnumVariant, ibc::core::connection::version::Version};

    impl TryFrom<protos::ibc::core::connection::v1::Version> for Version {
        type Error = UnknownEnumVariant<String>;

        fn try_from(
            proto: protos::ibc::core::connection::v1::Version,
