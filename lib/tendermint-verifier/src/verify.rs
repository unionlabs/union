...
mod tests {
    ...
    use cosmwasm_std::{BLS12_381_G1_GENERATOR, Deps, testing::mock_dependencies};
        ...
        fn filter_commit(
            ...
            if commit_sig.block_id_flag == Into::<i32>::into(BlockIdFlag::Commit) {
                ...
                Ok(Some(ValidatorSig {
                    validator_address: commit_sig.validator_address.unwrap().into_encoding(),
                    timestamp,
    ...
    impl From<EmptyError> for Error {
        fn from(_: EmptyError) -> Self {
