...
module zkgm::ibc_app {
    ...
    fun see_packet() {
        let packet =
            x"";
        let packet = zkgm_packet::decode(&packet);
        let packet =
            fungible_asset_order::decode(
                instruction::operand(&zkgm_packet::instruction(&packet))
            );
        let (wrapped_address, salt) =
            predict_wrapped_token(
                0,
