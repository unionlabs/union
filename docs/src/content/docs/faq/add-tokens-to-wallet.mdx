...
<Image src="/faq/btc_union_token_hover.png" width="3500" height="1400" alt="screenshot highlighting where to hover your mouse" />


3. Copy the token denom from the pop-up

<Image src="/faq/btc_union_token_denom.png" width="3500" height="1400" alt="screenshot highlighting denom info pop-up" />
...
<Image src="/faq/kelpr_manage_assets.png" width="3500" height="1400" alt="screenshot highlighting where to manage assets in kelpr" />
...
<Image src="/faq/leap_manage_assets.png" width="3500" height="1400"  alt="screenshot highlighting where to manage assets in kelpr" />
