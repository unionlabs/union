...
import btcUnionTokenDenom from "#/assets/images/faq/btc_union_token_denom.png"
import btcUnionTokenHover from "#/assets/images/faq/btc_union_token_hover.png"
import kelprManageAssets from "#/assets/images/faq/kelpr_manage_assets.png"
import leapManageAssets from "#/assets/images/faq/leap_manage_assets.png"
...
<Image src={btcUnionTokenHover} alt="screenshot highlighting where to hover your mouse" />


3. Copy the token denom from the pop-up

<Image src={btcUnionTokenDenom} alt="screenshot highlighting denom info pop-up" />
...
<Image src={kelprManageAssets} width="264" alt="screenshot highlighting where to manage assets in kelpr" />
...
<Image src={leapManageAssets} width="264" alt="screenshot highlighting where to manage assets in kelpr" />
