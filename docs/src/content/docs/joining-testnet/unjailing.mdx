...
Just like [creating your validator](/docs/joining-testnet/creating-validators/#epoch-staking--validator-set-updates), once you've unjailed your validator, they'll rejoin the active set at the end of the current epoch.
