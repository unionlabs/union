...
To be consistent across languages and implementations, ideally the types are flattened and called `Address<Ecosystem><Variant>`, for example `AddressCosmosCanonical`, `AddressEvmZkgm`.
