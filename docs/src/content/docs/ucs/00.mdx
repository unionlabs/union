...
<LinkCard title="UCS00 - CosmWasm reference implementation" description="Canonical UCS00 implementation in Rust" href="https://github.com/unionlabs/union/tree/main/cosmwasm/ucs00-pingpong" />
