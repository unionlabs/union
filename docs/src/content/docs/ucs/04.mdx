...
This is a list of all `universal_chain_id`s currently recognized by Union. To add yours, [open a PR for `universal-chain-ids.json`](https://github.com/unionlabs/union/blob/main/deployments/universal-chain-ids.json).
