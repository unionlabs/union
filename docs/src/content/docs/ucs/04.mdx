...
To disambiguate, UCS04 defines `universal_chain_id` as `<chain_family_name>.<chain_id>`. This has the additional advantage that chains are easier to recognize in logs and config files.
