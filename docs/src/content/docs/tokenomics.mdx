---
title: "Overview of the Union network and Union token"
---

Union is the zero-knowledge (zk) interoperability network that functions as a settlement and liquidity layer for protocols and asset issuers. It is powered by the Union token.
...
| -------------------------- | ----------------------------------------------------------------------------------------------- |
| Consensus Engine           | [CometBLS](https://docs.union.build/architecture/cometbls/), Union's ZK optimised CometBFT fork |
...
| ------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------- | ------------ |
| Incentives          | Genesis Drop and Testnet: 4%<br/>Future Incentives: 8%                                                                                                                                                                                                | 4% at TGE, 8% for future airdrops and liquidity incentives | 12.0%        |
...
| Foundation          | Protocol reserves for network development, operations, marketing, integrations, and strategic partnerships.                                                                                                                                           | 40% unlock at TGE, 1 year linear vesting                   | 20.0%        |
| Strategic Investors | Union's early backers from Seed and Series A rounds.                                                                                                                                                                                                  | 1 year cliff, 2 year linear vesting                        | 21.4%        |
| Core Contributors   | Core team members of Union entities and advisers.                                                                                                                                                                                                     | 1 year cliff, 3 year linear vesting                        | 20.0%        |
...
Genesis Drop, future incentives, DAO-driven governance, and ecosystem growth
programs, as well as the Union Foundation that's dedicated to supporting and
developing the network, Union ensures that the majority of its tokens are in the
hands of those shaping the network.
...
Community rewards, ecosystem growth, and DAO allocations are released steadily over time, ensuring tokens flow into productive long-term use cases. This approach creates predictability in circulating supply and enforces gradual unlocking schedules to avoid sharp supply shocks.
