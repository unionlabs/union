...
When bridging into L2s such as [Scroll](https://scroll.io), the [IBC](/docs/concepts/ibc) light client on $L1_A$ tracking a $L2$ on $L1_B$ needs to take the **Settlement Condition** into account.
