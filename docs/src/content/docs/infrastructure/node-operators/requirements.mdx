...
Officially, the Union team only supports running the Union node on linux based operating systems. (Ubuntu 22.04 and above)
...
The Union team will only distribute binaries for x86_64-linux (x86) and aarch64-linux (arm) machines.
