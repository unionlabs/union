...
<<<<<<<< HEAD:docs/src/content/docs/docs/architecture/cometbls.mdx
![cometbls mermaid](../../../../assets/cometbls.svg)
========
![cometbls mermaid](../../../assets/cometbls.svg)
>>>>>>>> 1f10a808b (feat(docs): start moving to astro starlight):docs/src/content/docs/architecture/cometbls.mdx
