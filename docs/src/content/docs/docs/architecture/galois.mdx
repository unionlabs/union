...
<<<<<<<< HEAD:docs/src/content/docs/docs/architecture/galois.mdx
![galois mermaid](../../../../assets/galois.svg)
========
![galois mermaid](../../../assets/galois.svg)
>>>>>>>> 1f10a808b (feat(docs): start moving to astro starlight):docs/src/content/docs/architecture/galois.mdx
