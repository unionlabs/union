...
```sh
<<<<<<<< HEAD:docs/src/content/docs/docs/infrastructure/node-operators/getting-started.mdx
docker pull ghcr.io/unionlabs/uniond:v0.17.0
========
docker pull ghcr.io/unionlabs/uniond:v0.14.0
>>>>>>>> 1f10a808b (feat(docs): start moving to astro starlight):docs/src/content/docs/infrastructure/node-operators/getting-started.mdx
```
