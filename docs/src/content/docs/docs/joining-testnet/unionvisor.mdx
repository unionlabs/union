...
```sh
<<<<<<<< HEAD:docs/src/content/docs/docs/joining-testnet/unionvisor.mdx
...
>>>>>>>> 1f10a808b (feat(docs): start moving to astro starlight):docs/src/content/docs/joining-testnet/unionvisor.mdx
```
