...
- For versions v0.15.0 and earlier
  ...
  ```sh
<<<<<<<< HEAD:docs/src/content/docs/docs/joining-testnet/obtaining-uniond.mdx
  export UNIOND_VERSION='v0.15.0'
========
  export UNIOND_VERSION='v0.14.0'
>>>>>>>> 1f10a808b (feat(docs): start moving to astro starlight):docs/src/content/docs/joining-testnet/obtaining-uniond.mdx
  docker pull ghcr.io/unionlabs/uniond:$UNIOND_VERSION
  ```

- For versions v0.17.0 and later
