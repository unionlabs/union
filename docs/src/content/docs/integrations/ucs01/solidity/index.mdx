...
Source code for this example can be found her: [ucs01-solidity-example](https://github.com/unionlabs/ucs01-solidity-example)
...
ETH Sepolia faucet: [sepolia.chain.link/sepolia](https://faucets.chain.link/sepolia)
