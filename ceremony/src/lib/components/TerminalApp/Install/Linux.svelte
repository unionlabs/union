<script lang="ts">
  ...
  onMount(() => {
    const messages = [
      ...
      {text: "4. Open Terminal from the Applications/Utilities/ folder", options: {duplicate: true}},
      {text: "5. Paste the following command in Terminal to start the MPC client:", options: {duplicate: true}},
      {text: "---", options: {duplicate: true}},
      {text: command, options: {duplicate: true}},
      {text: "---", options: {duplicate: true}},
      {text: "Once the MPC client is running you can return to this page.", options: {duplicate: true}},
      {
