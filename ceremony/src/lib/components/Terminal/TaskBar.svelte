<script lang="ts">
  ...
  let progressBar = $derived('#'.repeat(terminal.currentStep) + '='.repeat(terminal.maxStep - terminal.currentStep));
</script>

<div class="py-2 px-4 border-t w-full flex justify-between">
