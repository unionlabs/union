...
<section class="flex w-full h-full items-center justify-center">
  <div class="flex flex-col w-full h-full sm:max-h-[700px] bg-black max-w-4xl sm:border">
    <div class="w-full flex justify-between bg-neutral-800 px-4 py-2">
      <div class="flex items-center gap-2">
        ...
        <Button onclick={() => changeTab(1)} class={cn(terminal.tab === 1 ? "text-union-accent-500" : "text-white")}>Tab 1
        </Button>
        <Button onclick={() => changeTab(2)} class={cn(terminal.tab === 2 ? "text-union-accent-500" : "text-white")}>Tab 2</Button>
        <Button onclick={() => changeTab(3)} class={cn(terminal.tab === 3 ? "text-union-accent-500" : "text-white")}>Tab 3
        </Button>
