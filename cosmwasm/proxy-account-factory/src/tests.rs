...
//     assert!(
//         deps.storage
//             .maybe_read_item::<CwAccountCodeId>()
//             .unwrap()
//             .is_none()
//     );
...
//     assert_eq!(deps.storage.read_item::<CwAccountCodeId>().unwrap(), zkgm);
...
//     assert_eq!(
//         deps.storage.read_item::<CwAccountCodeId>().unwrap(),
//         new_zkgm
//     );
// }
