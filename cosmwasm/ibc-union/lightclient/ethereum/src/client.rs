...
use beacon_api_types::{
    ChainSpec, Mainnet, Minimal, PresetBaseKind, Slot, SyncCommittee,
...
fn update_state<C: ChainSpec>(
    ...
    if client_state.latest_height == consensus_update.finalized_header.execution.block_number {
        state_update = state_update.set_client_state(client_state);
    }
...
fn sync_committee_store_key_by_slot<C: SLOTS_PER_EPOCH + EPOCHS_PER_SYNC_COMMITTEE_PERIOD>(
    slot: Slot,
) -> Bytes {
