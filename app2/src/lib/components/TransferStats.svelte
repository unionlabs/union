      ...
      >
        {#if isMuted}
          <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
            <path fill-rule="evenodd" d="M9.383 3.076A1 1 0 0110 4v12a1 1 0 01-1.617.793L4.617 13H2a1 1 0 01-1-1V8a1 1 0 011-1h2.617l3.766-3.793a1 1 0 011.617.793zM16 8a1 1 0 011 1v2a1 1 0 11-2 0V9a1 1 0 011-1z" clip-rule="evenodd" />
            <path fill-rule="evenodd" d="M15.293 6.293a1 1 0 011.414 0L18 7.586l1.293-1.293a1 1 0 111.414 1.414L19.414 9l1.293 1.293a1 1 0 01-1.414 1.414L18 10.414l-1.293 1.293a1 1 0 01-1.414-1.414L16.586 9l-1.293-1.293a1 1 0 010-1.414z" clip-rule="evenodd" />
          </svg>
          <span>Muted</span>
        {:else}
          <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
