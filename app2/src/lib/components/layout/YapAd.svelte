  ...
  >
    ...
    <div class="flex flex-col justify-center flex-1 min-w-0">
      <div class="flex flex-col gap-1">
        <p class="text-xs text-zinc-300 leading-tight">Join the Yapocalypse and climb the leaderboard.</p>
      </div>

      <div class="flex items-end justify-between mt-2">
        <span class="group-hover:text-accent text-xs inline-flex items-center gap-1.5 text-orange-400 transition-all duration-300 font-medium tracking-wide">
