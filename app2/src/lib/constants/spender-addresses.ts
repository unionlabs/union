...
export const cosmosSpenderAddresses: Record<UniversalChainId, AddressCosmosDisplay> = Schema
  .decodeUnknownSync(Schema.Record({ key: UniversalChainId, value: AddressCosmosDisplay }))(
    raw,
  )
