 ...
 */
export type MultisigSteps = Data.TaggedEnum<{
  Filling: {}
  CheckReceiver: {
...
export type Filling = ExtractTag<MultisigSteps, "Filling">
export type CheckReceiver = ExtractTag<MultisigSteps, "CheckReceiver">
export type ApprovalRequired = ExtractTag<MultisigSteps, "ApprovalRequired">
export type SubmitInstruction = ExtractTag<MultisigSteps, "SubmitInstruction">
export type WaitForIndex = ExtractTag<MultisigSteps, "WaitForIndex">
