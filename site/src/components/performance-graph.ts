...
const resumeAnimation = (element: SVGPathElement) => (element.style.animationPlayState = 'running')
...
chartElement?.append(
  ...
  Plot.plot({
    ...
    marks: [
      ...
      Plot.dot(zkFastPlotLine, Plot.pointerX({ x: 'x', y: 'y', stroke: 'red', fill: 'red', r: 3 }))
    ]
  })
)
