---
title: "Union Testnet App is Live"
date: 2024-06-18
author: "union_build"
hidden: true
description: "Union Testnet App is Live: Enter the Endgame of Modular Interoperability"
cover: "/src/assets/images/union-testnet-app-live/cover.jpg"
---

import { Image } from "astro:assets";
import Demo from "#/assets/images/union-testnet-app-live/demo.png";
import Cover from "#/assets/images/union-testnet-app-live/cover.jpg";
...
<Image
  ...
  class="my-2"
  format={'avif'}
  alt="Union Testnet App is Live cover image"
/>
...
and start transferring assets. The Union public testnet is an absolutely crucial step in the journey toward a secure,
integrated, and composable future. (Try it now)[https://app.union.build].
...
- Connect your wallets (more coming soon)
  - EVM wallet: MetaMask
  - Cosmos wallets: Keplr, Leap
- Get testnet UNO tokens from the (Union Faucet)[https://app.union.build/faucet]
- Transfer UNO from Union testnet to Ethereum Sepolia with the (Transfer function)[https://app.union.build/transfer]
- Explore Union data on the (Explorer)[https://app.union.build/explorer]
- Bonus: Transfer UNO from Ethereum Sepolia back to Union testnet. Use the (QuickNode Sepolia Faucet)[https://faucet.quicknode.com/ethereum/sepolia] to get Sepolia ETH.
...
<Image
  ...
  loading="eager"
  format={'avif'}
  alt="Union Testnet App explorer page"
/>
...
To celebrate, we invite you to join our (Twitter Space)[https://x.com/i/spaces/1kvKpvmokzZJE] on **Friday, June 21st**,
...
Event Details:
  ...
  - Time: 2pm UTC
  - Guests: Union Co-founders (Karel)[https://x.com/0xkaiserkarel], (Cor)[https://x.com/corcoder], (Emir)[https://x.com/EBeriker], and more

Set a (reminder)[https://x.com/i/spaces/1kvKpvmokzZJE] on Twitter, and retweet the announcement to spread the word.

## Jump on the Union Train

It's time to explore the Union testnet and take part in this transformative journey.
Visit app.union.build to get started, and join the conversation on our Twitter Space to stay informed about the latest developments.

- Use the [Union Testnet App](https://app.union.build)
- Share the announcement
- (Follow Union on 𝕏)[https://twitter.com/union_build]
- (Join our Discord community)[https://discord.gg/union_build]
