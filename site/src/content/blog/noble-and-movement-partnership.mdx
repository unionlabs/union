...
hidden: false
imagePath: '/src/assets/images/noble-and-movement-partnership/union-movement-noble.svg'
---
...
<img src={celestiaImage.src} width="100%" alt="Celestia's modular stack" class="invert-1 my-4" />
