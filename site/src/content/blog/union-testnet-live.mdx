...
To celebrate, we invite you to join our [𝕏 Space](https://x.com/i/spaces/1kvKpvmokzZJE) on **Friday, June 21st**,
...
Set a [reminder](https://x.com/i/spaces/1kvKpvmokzZJE) on 𝕏, and retweet the announcement to spread the word.

## Jump on the Union Train

It's time to explore the Union testnet and take part in this transformative journey.
Visit [app.union.build](https://app.union.build) to get started, and join the conversation on our [𝕏 Space](https://x.com/i/spaces/1kvKpvmokzZJE) to stay informed about the latest developments.
