...
[Union](/), the sovereign interoperability layer, has formed a strategic partnership with [Lava](https://www.lavanet.xyz/), the modular access layer for Web3, marked by the announcement of an Incentivized Public Remote Procedure Call (ipRPC) campaign with a rewards pool worth $100K in token rewards. The alliance will also see Lava become the modular RPC and access layer connecting users to Union’s testnet.
