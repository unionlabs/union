...
<Tabs>
  <TabItem label='x86_64-linux'>
    ...
    curl --output uniond --location https://github.com/unionlabs/union/releases/download/v0.18.0/uniond-release-x86_64-linux
  ...
  <TabItem label='aarch64-linux'>
    ...
    curl --output uniond --location https://github.com/unionlabs/union/releases/download/v0.18.0/uniond-release-aarch64-linux
...
```sh
docker pull ghcr.io/unionlabs/uniond-release:v0.18.0
```
