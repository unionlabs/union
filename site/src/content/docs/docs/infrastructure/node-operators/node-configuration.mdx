...
For the Union Testnet, this value should be `"union-testnet-5"`.
...
Seed nodes help orchestrate initial connections to the network. For union-testnet-5, the seed nodes are:
