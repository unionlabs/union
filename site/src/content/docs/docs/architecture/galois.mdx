...
Galois is the umbrella term of Union's ZK efforts. It currently has one purpose: [consensus verification](/docs/concepts/consensus-verification/). We've built Galois around three fundamental principles:
