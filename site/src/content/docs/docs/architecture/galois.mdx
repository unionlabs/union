...
2. Low-cost: zero-knowledge provers are computationally expensive to operate, and often require large machine clusters. [Galoisd](https://github.com/unionlabs/union/blob/main/galoisd/README.md) can run on a single machine and still outperform other zk bridges.
...
![galois mermaid](../../../../assets/images/galois.svg)
