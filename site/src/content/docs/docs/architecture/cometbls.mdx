...
Note that the Union validators do not produce ZKPs directly. This function is performed by [galois](/docs/architecture/galois/).
...
Furthermore, because BLS signatures can be aggregated, we can employ [Distributed Validator Tech](/docs/concepts/distributed-validator-tech) to scale to **thousands of validators**.
