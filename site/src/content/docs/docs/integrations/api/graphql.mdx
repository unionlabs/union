...
A [Playground UI](https://cloud.hasura.io/public/graphiql?endpoint=https://graphql.union.build/v1/graphql) is also provided, which can be used 
...
<iframe 
  ...
  allowfullscreen
  allow="web-share"
  style="border: none; width: 100%; height: 555px;"
  src="https://www.val.town/embed/git/transfersquery"
></iframe>
