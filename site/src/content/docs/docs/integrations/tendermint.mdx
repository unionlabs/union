...
Opening a connection from CosmosSDK-based chains is a straightforward process. Until the recent release of [wasm light clients](https://www.ibcprotocol.dev/blog/wasm-client), the traditional way of having a light client on a Cosmos-SDK chain was
