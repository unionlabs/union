...
Union uses advanced [Zero-Knowledge Cryptography](/docs/concepts/zero-knowledge-cryptography) and [BLS](/docs/concepts/bls-signatures) signatures to bring the fastest and most secure inter-blockchain communication protocol, [IBC](/docs/concepts/ibc), everywhere. 
