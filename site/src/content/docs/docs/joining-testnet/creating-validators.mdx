...
If you successfully create your validator during the middle of an epoch, you will still need to wait until after the end of the current epoch for your validator to join the active set.
