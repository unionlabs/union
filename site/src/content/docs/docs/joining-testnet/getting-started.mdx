...
Welcome to the Union Testnet! This guide will instruct you on running a node and creating a validator for <FunctionResult result={'`' + import.meta.env.CHAIN_ID_VERSION + '`'} />.
