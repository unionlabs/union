...
Welcome to the Union Testnet! This guide will instruct you on running a node and creating a validator for `union-testnet-5`.
...
For more manual control, we also release each version of `uniond` as a Docker image. You can learn more in our [Obtaining the Client Binary](../obtaining-uniond) guide.
...
For others seeking to become validators, please stay tuned for more information. The best place to get the most recent information is [our Discord](https://discord.gg/union-build).
