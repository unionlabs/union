...
You may run the Union node on your own machine or a VPS, please ensure your machine or VPS meets our [node operator requirements](/docs/infrastructure/node-operators/requirements/).
