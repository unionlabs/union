...
```sh
docker run -v ~/.unionvisor:/.unionvisor -v /tmp:/tmp -it ghcr.io/unionlabs/bundle-testnet-4:$UNIONVISOR_VERSION init --moniker $MONIKER --network union-testnet-4 --seeds "a069a341154484298156a56ace42b6e6a71e7b9d@blazingbit.io:27656,8a07752a234bb16471dbb577180de7805ba6b5d9@union.testnet.4.seed.poisonphang.com:26656"
```
