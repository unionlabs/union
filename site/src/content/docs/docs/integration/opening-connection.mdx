...
needs to be opened first. This should be done after having the `Cometbls` light client on your chain though so make sure to follow our [configuration guide](/docs/integration/wasm-clients)
for that.
