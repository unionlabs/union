    ...
    <div>
        ...
        <div class="flex-col md:justify-end">
          ...
          {:else}
            <div class="flex md:justify-end">
              <span class="text-accent">{toFixedUno(BigInt($unionUnoBalance.amount))}</span
              >&nbsp;UNO
            </div>
          {/if}
        </div>
      ...
      <div class="flex-row md:columns-2">
        ...
        <div class="flex-col md:justify-end">
          ...
          {:else}
            <div class="flex md:justify-end">
              <span class="text-accent">{toFixedEth($ethereumEthBalance)}</span>&nbsp;ETH
            </div>
          {/if}
        </div>
      </div>
      <div class="flex-row md:columns-2">
        ...
        <div class="flex-col md:justify-end">
          ...
          {:else}
            <div class="flex md:justify-end">
              <span class="text-accent">{toFixedUno($ethereumUnoBalance)}</span>&nbsp;UNO
            </div>
          {/if}
        </div>
      </div>
