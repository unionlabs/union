...
pub struct Fee {
    ...
    pub recv_fee: ::prost::alloc::vec::Vec<::cosmos_sdk::cosmos::base::v1beta1::Coin>,
    /// the packet acknowledgement fee
    #[prost(message, repeated, tag = "2")]
    pub ack_fee: ::prost::alloc::vec::Vec<::cosmos_sdk::cosmos::base::v1beta1::Coin>,
    /// the packet timeout fee
    #[prost(message, repeated, tag = "3")]
    pub timeout_fee: ::prost::alloc::vec::Vec<::cosmos_sdk::cosmos::base::v1beta1::Coin>,
}
...
pub struct QueryIncentivizedPacketsRequest {
    ...
    pub pagination: ::core::option::Option<
        ::cosmos_sdk::cosmos::base::query::v1beta1::PageRequest,
    >,
...
pub struct QueryIncentivizedPacketsResponse {
    ...
    #[prost(message, optional, tag = "2")]
    pub pagination: ::core::option::Option<
        ::cosmos_sdk::cosmos::base::query::v1beta1::PageResponse,
    >,
}
...
pub struct QueryTotalRecvFeesResponse {
    ...
    #[prost(message, repeated, tag = "1")]
    pub recv_fees: ::prost::alloc::vec::Vec<::cosmos_sdk::cosmos::base::v1beta1::Coin>,
}
...
pub struct QueryTotalAckFeesResponse {
    ...
    #[prost(message, repeated, tag = "1")]
    pub ack_fees: ::prost::alloc::vec::Vec<::cosmos_sdk::cosmos::base::v1beta1::Coin>,
}
...
pub struct QueryTotalTimeoutFeesResponse {
    ...
    pub timeout_fees: ::prost::alloc::vec::Vec<
        ::cosmos_sdk::cosmos::base::v1beta1::Coin,
    >,
}
