...
impl serde::Serialize for Module {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cosmos.consensus.module.v1.Module", len)?;
        if !self.authority.is_empty() {
...
impl<'de> serde::Deserialize<'de> for Module {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("cosmos.consensus.module.v1.Module", FIELDS, GeneratedVisitor)
    }
}
