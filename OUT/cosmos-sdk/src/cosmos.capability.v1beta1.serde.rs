...
impl<'de> serde::Deserialize<'de> for Capability {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("cosmos.capability.v1beta1.Capability", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for CapabilityOwners {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cosmos.capability.v1beta1.CapabilityOwners", len)?;
        if !self.owners.is_empty() {
...
impl<'de> serde::Deserialize<'de> for CapabilityOwners {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("cosmos.capability.v1beta1.CapabilityOwners", FIELDS, GeneratedVisitor)
    }
}
...
impl<'de> serde::Deserialize<'de> for GenesisOwners {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("cosmos.capability.v1beta1.GenesisOwners", FIELDS, GeneratedVisitor)
    }
}
...
impl<'de> serde::Deserialize<'de> for GenesisState {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("cosmos.capability.v1beta1.GenesisState", FIELDS, GeneratedVisitor)
    }
}
