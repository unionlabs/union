...
pub struct Block {
    ...
    pub data: ::core::option::Option<::cometbls::tendermint::types::Data>,
    #[prost(message, optional, tag = "3")]
    pub evidence: ::core::option::Option<::cometbls::tendermint::types::EvidenceList>,
    #[prost(message, optional, tag = "4")]
    pub last_commit: ::core::option::Option<::cometbls::tendermint::types::Commit>,
}
...
pub struct Header {
    /// basic block info
    #[prost(message, optional, tag = "1")]
    pub version: ::core::option::Option<::cometbls::tendermint::version::Consensus>,
    #[prost(string, tag = "2")]
    ...
    pub last_block_id: ::core::option::Option<::cometbls::tendermint::types::BlockId>,
...
pub struct GetBlockByHeightResponse {
    #[prost(message, optional, tag = "1")]
    pub block_id: ::core::option::Option<::cometbls::tendermint::types::BlockId>,
    /// Deprecated: please use `sdk_block` instead
    #[prost(message, optional, tag = "2")]
    pub block: ::core::option::Option<::cometbls::tendermint::types::Block>,
...
pub struct GetNodeInfoResponse {
    ...
    pub default_node_info: ::core::option::Option<
        ::cometbls::tendermint::p2p::DefaultNodeInfo,
    >,
    #[prost(message, optional, tag = "2")]
