...
impl serde::Serialize for GenesisState {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("cosmos.genutil.v1beta1.GenesisState", len)?;
        if !self.gen_txs.is_empty() {
            struct_ser.serialize_field("genTxs", &self.gen_txs.iter().map(pbjson::private::base64::encode).collect::<Vec<_>>())?;
        }
        struct_ser.end()
    }
}
impl<'de> serde::Deserialize<'de> for GenesisState {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        deserializer.deserialize_struct("cosmos.genutil.v1beta1.GenesisState", FIELDS, GeneratedVisitor)
    }
}
