...
impl ::prost::Name for FrElement {
    ...
    const PACKAGE: &'static str = "union.galois.api.v2";
    fn full_name() -> ::prost::alloc::string::String {
        ::prost::alloc::format!("union.galois.api.v2.{}", Self::NAME)
    }
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct VerifyRequest {
    ...
    pub hashed_message: ::core::option::Option<FrElement>,
}
...
include!("union.galois.api.v2.tonic.rs");
