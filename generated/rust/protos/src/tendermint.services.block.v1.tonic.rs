...
pub mod block_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn get_by_height(
            &mut self,
            request: impl tonic::IntoRequest<super::GetByHeightRequest>,
        ) -> std::result::Result<tonic::Response<super::GetByHeightResponse>, tonic::Status>
        {
            ...
            req.extensions_mut().insert(GrpcMethod::new(
                "tendermint.services.block.v1.BlockService",
                "GetByHeight",
            ));
        ...
        pub async fn get_latest_height(
            ...
            tonic::Response<tonic::codec::Streaming<super::GetLatestHeightResponse>>,
            tonic::Status,
        > {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
