...
pub mod msg_creator_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        ) -> std::result::Result<tonic::Response<super::MsgCreateCosmWasmPoolResponse>, tonic::Status>
        {
...
pub mod query_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn pools(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/osmosis.cosmwasmpool.v1beta1.Query/Pools");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
        ...
        pub async fn params(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/osmosis.cosmwasmpool.v1beta1.Query/Params");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
                "osmosis.cosmwasmpool.v1beta1.Query",
                "Params",
        ...
        ) -> std::result::Result<tonic::Response<super::ContractInfoByPoolIdResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        pub async fn pool_raw_filtered_state(
            &mut self,
            request: impl tonic::IntoRequest<super::PoolRawFilteredStateRequest>,
        ) -> std::result::Result<tonic::Response<super::PoolRawFilteredStateResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/osmosis.cosmwasmpool.v1beta1.Query/PoolRawFilteredState",
            );
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
                "osmosis.cosmwasmpool.v1beta1.Query",
