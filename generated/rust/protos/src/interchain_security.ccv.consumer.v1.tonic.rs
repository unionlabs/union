...
pub mod query_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn query_next_fee_distribution(
            &mut self,
            request: impl tonic::IntoRequest<super::QueryNextFeeDistributionEstimateRequest>,
        ) -> std::result::Result<
        ...
        ) -> std::result::Result<tonic::Response<super::QueryProviderInfoResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
