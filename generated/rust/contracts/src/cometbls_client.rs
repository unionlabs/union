...
pub mod cometbls_client {
            ...
            errors: ::core::convert::From::from([
                ...
                (
                    ...
                    ::std::vec![
                        ::ethers::core::abi::ethabi::AbiError {
                            name: ::std::borrow::ToOwned::to_owned(
                                "ErrTrustedConsensusStateNotFound",
                            ),
                            inputs: ::std::vec![],
                        },
                    ],
    ...
    #[cfg(feature = "providers")]
    pub static COMETBLSCLIENT_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __DEPLOYED_BYTECODE,
    );
    #[cfg(feature = "providers")]
    ...
    impl ::ethers::core::abi::AbiDecode for CometblsClientErrors {
        fn decode(
            ...
            if let Ok(decoded) = <ErrClientFrozen as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::ErrClientFrozen(decoded));
            }
            if let Ok(decoded) = <ErrDelayPeriodNotExpired as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::ErrDelayPeriodNotExpired(decoded));
            }
            if let Ok(decoded) = <ErrHeaderExpired as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::ErrHeaderExpired(decoded));
            }
            if let Ok(decoded) = <ErrInvalidMisbehavior as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::ErrInvalidMisbehavior(decoded));
            }
            if let Ok(decoded) = <ErrInvalidMisbehaviorHeadersSequence as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::ErrInvalidMisbehaviorHeadersSequence(decoded));
            }
            if let Ok(decoded) = <ErrInvalidUntrustedValidatorsHash as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::ErrInvalidUntrustedValidatorsHash(decoded));
            }
            if let Ok(decoded) = <ErrInvalidZKP as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::ErrInvalidZKP(decoded));
            }
            if let Ok(decoded) = <ErrMaxClockDriftExceeded as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::ErrMaxClockDriftExceeded(decoded));
            }
            if let Ok(decoded) = <ErrNotIBC as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::ErrNotIBC(decoded));
            }
            if let Ok(decoded) = <ErrTrustedConsensusStateNotFound as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::ErrTrustedConsensusStateNotFound(decoded));
            }
            if let Ok(decoded) = <ErrUntrustedHeightLTETrustedHeight as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::ErrUntrustedHeightLTETrustedHeight(decoded));
            }
            if let Ok(decoded) = <ErrUntrustedTimestampLTETrustedTimestamp as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
    ...
    impl ::ethers::core::abi::AbiEncode for CometblsClientErrors {
        fn encode(self) -> ::std::vec::Vec<u8> {
            match self {
                ...
                Self::ErrClientFrozen(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                Self::ErrDelayPeriodNotExpired(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                Self::ErrHeaderExpired(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                ...
                Self::ErrInvalidZKP(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                Self::ErrMaxClockDriftExceeded(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
                Self::ErrNotIBC(element) => {
                    ::ethers::core::abi::AbiEncode::encode(element)
                }
    ...
    impl ::core::convert::From<ErrInvalidMisbehaviorHeadersSequence>
    for CometblsClientErrors {
        fn from(value: ErrInvalidMisbehaviorHeadersSequence) -> Self {
            Self::ErrInvalidMisbehaviorHeadersSequence(value)
        }
    }
    impl ::core::convert::From<ErrInvalidUntrustedValidatorsHash>
    for CometblsClientErrors {
    ...
    impl ::ethers::core::abi::AbiDecode for CometblsClientCalls {
        fn decode(
            ...
            if let Ok(decoded) = <GetTimestampAtHeightCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <MisbehaviorCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <VerifyMembershipCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::VerifyMembership(decoded));
            }
            if let Ok(decoded) = <VerifyNonMembershipCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::VerifyNonMembership(decoded));
            }
            if let Ok(decoded) = <VerifyZKPCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
