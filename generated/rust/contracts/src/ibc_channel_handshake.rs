...
pub mod ibc_channel_handshake {
            ...
            errors: ::core::convert::From::from([
                ...
                (
                    ...
                    ::std::vec![
                        ::ethers::core::abi::ethabi::AbiError {
                            name: ::std::borrow::ToOwned::to_owned(
                                "ErrCounterpartyChannelNotEmpty",
                            ),
                            inputs: ::std::vec![],
                        },
                    ],
    ...
    #[cfg(feature = "providers")]
    pub static IBCCHANNELHANDSHAKE_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    ...
    #[cfg(feature = "providers")]
    pub static IBCCHANNELHANDSHAKE_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __BYTECODE,
    );
    #[rustfmt::skip]
    #[cfg(feature = "providers")]
    ...
    #[cfg(feature = "providers")]
    pub static IBCCHANNELHANDSHAKE_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __DEPLOYED_BYTECODE,
    );
    #[cfg(feature = "providers")]
    ...
    impl ::ethers::core::abi::AbiDecode for IBCChannelHandshakeErrors {
        fn decode(
            ...
            if let Ok(decoded) = <ErrCapabilityAlreadyClaimed as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <ErrConnNotSingleHop as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::ErrConnNotSingleHop(decoded));
            }
            if let Ok(decoded) = <ErrConnNotSingleVersion as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::ErrConnNotSingleVersion(decoded));
            }
            if let Ok(decoded) = <ErrCounterpartyChannelNotEmpty as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::ErrCounterpartyChannelNotEmpty(decoded));
            }
            if let Ok(decoded) = <ErrInvalidChannelState as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <ErrInvalidHexAddress as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <ErrUnsupportedFeature as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
    ...
    impl ::core::convert::From<ErrCapabilityAlreadyClaimed>
    ...
    impl ::core::convert::From<ErrCounterpartyChannelNotEmpty>
    for IBCChannelHandshakeErrors {
    ...
    impl ::ethers::contract::EthLogDecode for IBCChannelHandshakeEvents {
        fn decode_log(
            ...
            if let Ok(decoded) = ChannelCloseConfirmFilter::decode_log(log) {
                return Ok(IBCChannelHandshakeEvents::ChannelCloseConfirmFilter(decoded));
            }
    ...
    impl ::core::convert::From<NextChannelSequencePathCall>
    for IBCChannelHandshakeCalls {
    ...
    impl ::core::convert::From<NextConnectionSequencePathCall>
    for IBCChannelHandshakeCalls {
