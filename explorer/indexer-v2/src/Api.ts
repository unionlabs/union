...
export class HealthApi extends HttpApiGroup.make("health", { topLevel: true })
  ...
  .annotateContext(
    OpenApi.annotations({ title: "Health", description: "Health and status endpoints" }),
  )
{}
...
export class ChainApi extends HttpApiGroup.make("chain")
  ...
  .annotateContext(
    OpenApi.annotations({
      title: "Chain Data",
      description: "Block and transaction data per chain",
    }),
  )
{}
...
export class AnalyticsApi extends HttpApiGroup.make("analytics")
  ...
  .add(
    HttpApiEndpoint.get("chainStatsHistory", "/:chainId/analytics/stats/history")
      ...
      .setUrlParams(
        Schema.Struct({
          limit: Schema.optionalWith(Schema.NumberFromString, { default: () => 100 }),
        }),
      )
  ...
  .add(
    HttpApiEndpoint.get("hourly", "/:chainId/analytics/hourly")
      ...
      .setUrlParams(
        Schema.Struct({
          hours: Schema.optionalWith(Schema.NumberFromString, { default: () => 24 }),
        }),
      )
  ...
  .annotateContext(
    OpenApi.annotations({ title: "Analytics", description: "Chain analytics and statistics" }),
  )
{}
...
export class ProxyApi extends HttpApiGroup.make("proxy")
  ...
  .annotateContext(
    OpenApi.annotations({
      title: "Proxy",
      description: "Proxy requests to chain RPC/REST endpoints",
    }),
  )
{}
