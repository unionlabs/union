...
//         let hops = ibc::get_counterparty_hops(connection_id);
...
//         let _ = ibc::generate_channel_identifier();

//         // Verify the next sequence has incremented
//         let next_sequence = ibc::get_next_channel_sequence();
...
//         let retrieved_connection_end = ibc::ensure_connection_state(connection_id);
...
//         let (retrieved_connection_id, retrieved_connection_end) = ibc::ensure_connection_feature(connection_hops, ORDER_ORDERED);
...
//         ibc::channel_open_init(string::utf8(b"port-0"), channel, signer::address_of(alice));
//     }
