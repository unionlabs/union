module IBC::IBCCommitmentTest {
    ...
    public fun test_channel_path() {
        let test_port = StringModule::utf8(b"test_port");
        let test_channel = StringModule::utf8(b"test_channel");
        let val = IBCCommitment::channel_path(test_port, test_channel);

        assert!(val == StringModule::utf8(b"channelEnds/ports/test_port/channels/test_channel"), E_TEST_CHANNEL_PATH);
    }
    ...
    public fun test_client_state_commitment_key() {
        let client_id = StringModule::utf8(b"client_id");
    ...
    public fun test_connection_commitment_key() {
        let connection_id = StringModule::utf8(b"connection_id");
    ...
    public fun test_packet_commitment_key() {
        let port_id = StringModule::utf8(b"port_id");
        let channel_id = StringModule::utf8(b"channel_id");
