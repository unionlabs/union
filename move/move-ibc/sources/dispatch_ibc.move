module ibc::sample_ibc {
    ...
    fun test_register(publisher: &signer) {
        ...
        //     param2
        // );
        // std::debug::print(&string::utf8(b"returned data is: "));
        // std::debug::print(&param2);
...
//                 } else {
//                     let acknowledgement = engine::dispatch<dynamic_dispatch_app2::TestProof2, dynamic_dispatch_app2::DynamicDispatchParam>(param2);
