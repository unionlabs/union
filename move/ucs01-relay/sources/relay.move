module UCS01::ibc {    
    ...
    #[test]
    public fun test_encode_2() {
        let token = Token {
            denom: string::utf8(b"@8acebbc26f06174786ab677af24850333edac06cc98c17655549fa498b819900"),
            amount: 133,
        };
        let packet = RelayPacket {
            sender: x"1363462745291c711144011c1305e737dd74ace69a5576612745e29a2e4fa1b5",
            receiver: x"4bde1d877da529ce4f78810b4b746bcc301c9380",
            tokens: vector[token],
