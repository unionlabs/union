...
contract MockClient is ILightClient {
    ...
    function verifyMembership(
        ...
        console.logBytes32(sha256(value));
        console.logBytes32(proof.toBytes32(0));
    ...
    function parseHeader(bytes memory bz) internal pure returns (IbcCoreClientV1Height.Data memory, uint64) {
