...
contract TestnetVerifier is IZKVerifier {
    ...
    function verifyingKey() internal pure returns (VerifyingKey memory vk) {
        vk.alfa1 = Pairing.G1Point(
            ...
            uint256(
                2813918487984701514495866538640757245795310074506986809086187064257311477759
            )
        );
        vk.beta2 = Pairing.G2Point(
            ...
            [
                ...
                uint256(
                    3554513121429906029657855924332897856861387724805388158790066103361201204210
                )
            ]
        );
        vk.gamma2 = Pairing.G2Point(
            [
                ...
                uint256(
                    2549029521023100058468087326457927716968672157213288863707354374956257266809
                )
            ],
            [
                uint256(
                    160761816387853926196115454931163650061973435705108488809338003258641051841
                ),
                uint256(
        ...
        vk.delta2 = Pairing.G2Point(
            ...
            [
                uint256(
                    5377251285991785595312700760925386441208533509670674647478120822710314216997
                ),
                uint256(
