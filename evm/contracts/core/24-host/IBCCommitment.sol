...
library IBCCommitment {
    ...
    function clientStatePathMerkle(
        string memory clientId
    ) internal pure returns (bytes[] memory) {
    ...
    function consensusStatePathMerkle(
        string memory clientId,
        uint64 revisionNumber,
        uint64 revisionHeight
    ) internal pure returns (bytes[] memory) {
    ...
    function packetCommitmentPathMerkle(
        string memory portId,
        string memory channelId,
        uint64 sequence
    ) internal pure returns (bytes[] memory) {
    ...
    function packetAcknowledgementCommitmentPathMerkle(
        string memory portId,
        string memory channelId,
        uint64 sequence
    ) internal pure returns (bytes[] memory) {
