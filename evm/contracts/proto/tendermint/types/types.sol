...
library TendermintTypesCommitSig {
  ...
  function _read_block_id_flag(
    ...
    (int64 tmp, uint256 sz) = ProtoBufRuntime._decode_enum(p, bs);
    TendermintTypesTypesGlobalEnums.BlockIDFlag x = TendermintTypesTypesGlobalEnums.decode_BlockIDFlag(tmp);
    r.block_id_flag = x;
    return sz;
  }
    ...
    returns (uint)
  {
    ...
    int32 _enum_block_id_flag = TendermintTypesTypesGlobalEnums.encode_BlockIDFlag(r.block_id_flag);
  ...
  function _estimate(
    ...
    uint256 e;
    e += 1 + ProtoBufRuntime._sz_enum(TendermintTypesTypesGlobalEnums.encode_BlockIDFlag(r.block_id_flag));
    e += 1 + ProtoBufRuntime._sz_lendelim(r.validator_address.length);
    e += 1 + ProtoBufRuntime._sz_lendelim(GoogleProtobufTimestamp._estimate(r.timestamp));
    e += 1 + ProtoBufRuntime._sz_lendelim(r.signature.length);
    return e;
