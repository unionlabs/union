...
library TendermintTypesCanonicalBlockID {
  ...
  function _read_part_set_header(
    ...
    (TendermintTypesCanonicalPartSetHeader.Data memory x, uint256 sz) = _decode_TendermintTypesCanonicalPartSetHeader(p, bs);
    r.part_set_header = x;
    return sz;
  }
   ...
   */
  function _decode_TendermintTypesCanonicalPartSetHeader(uint256 p, bytes memory bs)
    internal
    pure
    returns (TendermintTypesCanonicalPartSetHeader.Data memory, uint)
  {
    ...
    pointer += bytesRead;
    (TendermintTypesCanonicalPartSetHeader.Data memory r, ) = TendermintTypesCanonicalPartSetHeader._decode(pointer, bs, sz);
    ...
    returns (uint)
  {
    ...
    pointer += TendermintTypesCanonicalPartSetHeader._encode_nested(r.part_set_header, pointer, bs);
  ...
  function _estimate(
    ...
    e += 1 + ProtoBufRuntime._sz_lendelim(TendermintTypesCanonicalPartSetHeader._estimate(r.part_set_header));
    return e;
  }
  // empty checker
  ...
  function store(Data memory input, Data storage output) internal {
    ...
    TendermintTypesCanonicalPartSetHeader.store(input.part_set_header, output.part_set_header);
...
library TendermintTypesCanonicalProposal {
  ...
  function _read_type(
    ...
    TendermintTypesTypesGlobalEnums.SignedMsgType x = TendermintTypesTypesGlobalEnums.decode_SignedMsgType(tmp);
    r.type_ = x;
    return sz;
  }
  ...
  function _read_block_id(
    ...
    (TendermintTypesCanonicalBlockID.Data memory x, uint256 sz) = _decode_TendermintTypesCanonicalBlockID(p, bs);
    r.block_id = x;
    return sz;
  }
   ...
   * @return The number of bytes used to decode
   */
  function _decode_TendermintTypesCanonicalBlockID(uint256 p, bytes memory bs)
    internal
    pure
    returns (TendermintTypesCanonicalBlockID.Data memory, uint)
  {
    ...
    (uint256 sz, uint256 bytesRead) = ProtoBufRuntime._decode_varint(pointer, bs);
    pointer += bytesRead;
    (TendermintTypesCanonicalBlockID.Data memory r, ) = TendermintTypesCanonicalBlockID._decode(pointer, bs, sz);
    return (r, sz + bytesRead);
  }
    ...
    returns (uint)
  {
    ...
    int32 _enum_type = TendermintTypesTypesGlobalEnums.encode_SignedMsgType(r.type_);
    ...
    pointer += TendermintTypesCanonicalBlockID._encode_nested(r.block_id, pointer, bs);
  ...
  function _estimate(
    ...
    uint256 e;
    e += 1 + ProtoBufRuntime._sz_enum(TendermintTypesTypesGlobalEnums.encode_SignedMsgType(r.type_));
    e += 1 + 8;
    e += 1 + 8;
    e += 1 + ProtoBufRuntime._sz_int64(r.pol_round);
    e += 1 + ProtoBufRuntime._sz_lendelim(TendermintTypesCanonicalBlockID._estimate(r.block_id));
