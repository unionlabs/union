...
library IbcApplicationsInterchain_accountsV1InterchainAccountPacketData {
  ...
  function _read_type(
    ...
    IbcApplicationsInterchainAccountsV1PacketGlobalEnums.Type x = IbcApplicationsInterchainAccountsV1PacketGlobalEnums.decode_Type(tmp);
    r.type_ = x;
    return sz;
  }
    ...
    returns (uint)
  {
    ...
    int32 _enum_type = IbcApplicationsInterchainAccountsV1PacketGlobalEnums.encode_Type(r.type_);
  ...
  function _estimate(
    ...
    uint256 e;
    e += 1 + ProtoBufRuntime._sz_enum(IbcApplicationsInterchainAccountsV1PacketGlobalEnums.encode_Type(r.type_));
