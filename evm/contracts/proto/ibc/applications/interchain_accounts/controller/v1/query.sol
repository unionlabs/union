...
library
    IbcApplicationsInterchain_accountsControllerV1QueryInterchainAccountRequest {
    //struct definition
    struct Data {
        string owner;
...
library
    IbcApplicationsInterchain_accountsControllerV1QueryInterchainAccountResponse {
    //struct definition
    struct Data {
        string address_;
    }
