...
library IbcCoreConnectionV1ConnectionEnd {
    ...
    function _read_state(
        ...
        IbcCoreConnectionV1GlobalEnums.State x = IbcCoreConnectionV1GlobalEnums
            .decode_State(tmp);
        r.state = x;
        return sz;
    }
    ...
    function _encode(
        ...
        if (uint(r.state) != 0) {
            ...
            int32 _enum_state = IbcCoreConnectionV1GlobalEnums.encode_State(
                r.state
            );
...
library IbcCoreConnectionV1Counterparty {
    ...
    function _read_prefix(
        ...
        (
            IbcCoreCommitmentV1MerklePrefix.Data memory x,
            uint256 sz
...
library IbcCoreConnectionV1ClientPaths {
    ...
    function _decode(
        ...
        while (pointer < offset + sz) {
            ...
            pointer += bytesRead;
            if (fieldId == 1) {
                pointer += _read_unpacked_repeated_paths(
                    pointer,
                    bs,
                    nil(),
                    counters
