...
library IbcCoreConnectionV1ConnectionEnd {
  ...
  function _read_state(
    ...
    IbcCoreConnectionV1GlobalEnums.State x = IbcCoreConnectionV1GlobalEnums.decode_State(tmp);
    r.state = x;
    return sz;
  }
    ...
    returns (uint)
  {
    ...
    int32 _enum_state = IbcCoreConnectionV1GlobalEnums.encode_State(r.state);
  ...
  function _estimate(
    ...
    e += 1 + ProtoBufRuntime._sz_enum(IbcCoreConnectionV1GlobalEnums.encode_State(r.state));
