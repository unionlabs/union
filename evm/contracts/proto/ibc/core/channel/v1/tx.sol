...
library IbcCoreChannelV1MsgRecvPacketResponse {
  ...
  function _read_result(
    ...
    IbcCoreChannelV1TxGlobalEnums.ResponseResultType x = IbcCoreChannelV1TxGlobalEnums.decode_ResponseResultType(tmp);
    r.result = x;
    return sz;
  }
    ...
    returns (uint)
  {
    ...
    int32 _enum_result = IbcCoreChannelV1TxGlobalEnums.encode_ResponseResultType(r.result);
  ...
  function _estimate(
    ...
    uint256 e;
    e += 1 + ProtoBufRuntime._sz_enum(IbcCoreChannelV1TxGlobalEnums.encode_ResponseResultType(r.result));
    return e;
  }
  // empty checker
