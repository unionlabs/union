...
library IbcCoreChannelV1Channel {
  ...
  function _read_state(
    ...
    IbcCoreChannelV1GlobalEnums.State x = IbcCoreChannelV1GlobalEnums.decode_State(tmp);
    r.state = x;
    return sz;
  }
  ...
  function _read_ordering(
    ...
    (int64 tmp, uint256 sz) = ProtoBufRuntime._decode_enum(p, bs);
    IbcCoreChannelV1GlobalEnums.Order x = IbcCoreChannelV1GlobalEnums.decode_Order(tmp);
    r.ordering = x;
    return sz;
  }
    ...
    returns (uint)
  {
    ...
    int32 _enum_state = IbcCoreChannelV1GlobalEnums.encode_State(r.state);
    ...
    int32 _enum_ordering = IbcCoreChannelV1GlobalEnums.encode_Order(r.ordering);
  ...
  function _estimate(
    ...
    uint256 e;uint256 i;
    e += 1 + ProtoBufRuntime._sz_enum(IbcCoreChannelV1GlobalEnums.encode_State(r.state));
    e += 1 + ProtoBufRuntime._sz_enum(IbcCoreChannelV1GlobalEnums.encode_Order(r.ordering));
