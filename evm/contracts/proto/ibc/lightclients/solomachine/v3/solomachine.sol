...
library IbcLightclientsSolomachineV3ClientState {
  ...
  function _read_consensus_state(
    ...
    (IbcLightclientsSolomachineV3ConsensusState.Data memory x, uint256 sz) = _decode_IbcLightclientsSolomachineV3ConsensusState(p, bs);
    r.consensus_state = x;
    return sz;
  }
   ...
   */
  function _decode_IbcLightclientsSolomachineV3ConsensusState(uint256 p, bytes memory bs)
    internal
    pure
    returns (IbcLightclientsSolomachineV3ConsensusState.Data memory, uint)
  {
    uint256 pointer = p;
    (uint256 sz, uint256 bytesRead) = ProtoBufRuntime._decode_varint(pointer, bs);
    pointer += bytesRead;
    (IbcLightclientsSolomachineV3ConsensusState.Data memory r, ) = IbcLightclientsSolomachineV3ConsensusState._decode(pointer, bs, sz);
    ...
    returns (uint)
  {
    ...
    pointer += IbcLightclientsSolomachineV3ConsensusState._encode_nested(r.consensus_state, pointer, bs);
  ...
  function _estimate(
    ...
    e += 1 + 1;
    e += 1 + ProtoBufRuntime._sz_lendelim(IbcLightclientsSolomachineV3ConsensusState._estimate(r.consensus_state));
    return e;
  }
  // empty checker
  ...
  function store(Data memory input, Data storage output) internal {
    ...
    IbcLightclientsSolomachineV3ConsensusState.store(input.consensus_state, output.consensus_state);
...
library IbcLightclientsSolomachineV3Misbehaviour {
  ...
  function _read_signature_one(
    ...
    (IbcLightclientsSolomachineV3SignatureAndData.Data memory x, uint256 sz) = _decode_IbcLightclientsSolomachineV3SignatureAndData(p, bs);
    r.signature_one = x;
    return sz;
  }
   ...
   * @return The number of bytes used to decode
   */
  function _decode_IbcLightclientsSolomachineV3SignatureAndData(uint256 p, bytes memory bs)
    internal
    pure
    returns (IbcLightclientsSolomachineV3SignatureAndData.Data memory, uint)
  {
    uint256 pointer = p;
    (uint256 sz, uint256 bytesRead) = ProtoBufRuntime._decode_varint(pointer, bs);
    pointer += bytesRead;
    (IbcLightclientsSolomachineV3SignatureAndData.Data memory r, ) = IbcLightclientsSolomachineV3SignatureAndData._decode(pointer, bs, sz);
    return (r, sz + bytesRead);
  }
    ...
    returns (uint)
  {
    ...
    pointer += IbcLightclientsSolomachineV3SignatureAndData._encode_nested(r.signature_one, pointer, bs);
    ...
    pointer += IbcLightclientsSolomachineV3SignatureAndData._encode_nested(r.signature_two, pointer, bs);
  ...
  function _estimate(
    ...
    uint256 e;
    e += 1 + ProtoBufRuntime._sz_uint64(r.sequence);
    e += 1 + ProtoBufRuntime._sz_lendelim(IbcLightclientsSolomachineV3SignatureAndData._estimate(r.signature_one));
    e += 1 + ProtoBufRuntime._sz_lendelim(IbcLightclientsSolomachineV3SignatureAndData._estimate(r.signature_two));
    return e;
  }
  // empty checker
  ...
  function store(Data memory input, Data storage output) internal {
    output.sequence = input.sequence;
    IbcLightclientsSolomachineV3SignatureAndData.store(input.signature_one, output.signature_one);
    IbcLightclientsSolomachineV3SignatureAndData.store(input.signature_two, output.signature_two);
