...
library IbcLightclientsSolomachineV2SignatureAndData {
  ...
  struct Data {
    bytes signature;
    IbcLightClientsSolomachineV2SolomachineGlobalEnums.DataType data_type;
    bytes data;
    uint64 timestamp;
  }
  ...
  function _read_data_type(
    ...
    IbcLightClientsSolomachineV2SolomachineGlobalEnums.DataType x = IbcLightClientsSolomachineV2SolomachineGlobalEnums.decode_DataType(tmp);
    r.data_type = x;
    return sz;
  }
    ...
    returns (uint)
  {
    ...
    int32 _enum_data_type = IbcLightClientsSolomachineV2SolomachineGlobalEnums.encode_DataType(r.data_type);
  ...
  function _estimate(
    ...
    uint256 e;
    e += 1 + ProtoBufRuntime._sz_lendelim(r.signature.length);
    e += 1 + ProtoBufRuntime._sz_enum(IbcLightClientsSolomachineV2SolomachineGlobalEnums.encode_DataType(r.data_type));
...
library IbcLightClientsSolomachineV2SolomachineGlobalEnums {
