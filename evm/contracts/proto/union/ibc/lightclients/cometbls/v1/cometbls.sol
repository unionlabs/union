...
library UnionIbcLightclientsCometblsV1ClientState {
    ...
    function _read_trust_level(
        ...
        (
            UnionIbcLightclientsCometblsV1Fraction.Data memory x,
            uint256 sz
        ) = _decode_UnionIbcLightclientsCometblsV1Fraction(p, bs);
        r.trust_level = x;
        return sz;
    }
     ...
     */
    function _decode_UnionIbcLightclientsCometblsV1Fraction(
        uint256 p,
        bytes memory bs
    )
        internal
        ...
        returns (UnionIbcLightclientsCometblsV1Fraction.Data memory, uint)
    {
        ...
        pointer += bytesRead;
        (
            UnionIbcLightclientsCometblsV1Fraction.Data memory r,

        ) = UnionIbcLightclientsCometblsV1Fraction._decode(pointer, bs, sz);
    ...
    function _encode(
        ...
        pointer += UnionIbcLightclientsCometblsV1Fraction._encode_nested(
            r.trust_level,
            pointer,
            bs
        );
    ...
    function _estimate(Data memory r) internal pure returns (uint) {
        ...
        e +=
            ...
            ProtoBufRuntime._sz_lendelim(
                UnionIbcLightclientsCometblsV1Fraction._estimate(r.trust_level)
            );
        e +=
            1 +
            ProtoBufRuntime._sz_lendelim(
    ...
    function store(Data memory input, Data storage output) internal {
        ...
        UnionIbcLightclientsCometblsV1Fraction.store(
            input.trust_level,
            output.trust_level
        );
...
library UnionIbcLightclientsCometblsV1Misbehaviour {
    ...
    function _read_header_1(
        ...
        (
            UnionIbcLightclientsCometblsV1Header.Data memory x,
            uint256 sz
