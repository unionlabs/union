...
contract IBCChannelTest is TestPlus {
    ...
    function setupConnection_chainA(uint64 proofHeight)
        internal
        returns (string memory clientId, string memory connId)
    {
        // 1. createClient
    ...
    function setupConnection_chainB(uint64 proofHeight)
        internal
        returns (string memory clientId, string memory connId)
    {
        // 1. createClient
