...
contract StateLensIcs23Ics23ClientTest is Test {
    ...
    function test_verifyMembershipV3(address caller, address relayer) public {
        uint32 clientId = 1;
        ...
        ClientState memory clientState = ClientState({
            ...
            state: ExtraV3({
                storeKey: bytes("main"),
                keyPrefixStorage: hex"2f70762f766d3a676e6f2e6c616e642f722f636f72652f6962632f76312f636f72653a"
            }).encode()
        });
        bytes memory clientStateBytes = abi.encode(
            clientState.l2ChainId,
        ...
        ConsensusState memory consensusState = ConsensusState({
            timestamp: uint64(block.timestamp),
            appHash: 0x8840d7f84ca854e31f7b6e88bcacdede553f94798be53bd64023bc0408db6d11
        });
        bytes memory consensusStateBytes =
            abi.encode(consensusState.timestamp, consensusState.appHash);
        ...
        // voyager rpc ibc-proof dev '{"connection":{"connection_id":2}}' --encode --ibc-interface ibc-solidity --client-type state-lens/ics23/ics23 --height 28
        // TODO: Replace this with a query from a non-dev gno chain once the contracts are deployed
        bytes memory proof =
            hex"";
        ...
        bool ok = client.verifyMembership(
            ...
            proof,
            // u path connection 2
            hex"679795a0195a1b76cdebb7c51d74e058aee92919b8c3389af86ef24535e8a28c",
            hex"741e7a9d296565b8c15953765b58f5fbb27b116a0c14fd5e89c86f3df6d8f062"
        );
        assert(ok);
    }
}
