...
contract CodecTest is Test {
    function test_consensusState_encode_decode_iso(uint64 timestamp, bytes32 root, bytes32 nextValidatorsHash) public {
        ...
        assertEq(consensusState.nextValidatorsHash, consensusState2.nextValidatorsHash);
    }
}
